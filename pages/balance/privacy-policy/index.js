    ...
    return (
        <>
            ...
            <GenericContainer className="balance_privacy_policy">
                ...
                <p>Please take a moment to familiarize yourself with Balance's privacy practices, and feel free to <a href="mailto:hi@lausandoval.com">contact me</a> if you have any questions.</p>
                ...
                <p>If you have any further questions, feel free to contact me via <a href="https://twitter.com/laurasideral">Twitter</a>, <a href="https://instagram.com/laurasideral">Instagram</a>, or at <a href="mailto:hi@lausandoval.com">hi@lausandoval.com</a>.</p>
            </GenericContainer>
        </>
    )
}
