  ...
  res.status(200).json([
    {
      ...
      "team": {
        "Team": [
          ...
          {
            "name": "Francisco Bulnes"
          },
          {
            "name": "Gricelle Bouvier"
          },
          {
            "name": "Javiera Sanhueza"
          },
          {
            "name": "Laura Sandoval"
          },
    ...
    },
    {
      ...
      "client": null,
      "description": [
        "Featured at the 2019 Iberoamerican Design Bienniale in Madrid, Spain, my 2019 unofficial transit map for Santiago de Chile's Metro & rail network explores a versatile graphic system that allows for expansion or compression based on the required levels of complexity.",
        ...
        "40 physical copies of the map were printed, framed, and bought by beloved transit enthusiasts during 2019.",
    ...
    },
    {
      ...
      "thumbnails": [
        ...
        "cornershop-web-app-ipad-pro-11-inch.png",
      ...
      "cta": [
        {
          ...
          "url": "https://web.cornershopapp.com"
        }
      ],
      "team": {
        "Product Design": [
